...
namespace acc3d::Graphics
{
	...
	struct ShaderCompilationParameters
	{
		...
		static ShaderCompilationParameters Param_CompileVS_StdIncNoFlagsMainEntry(LPCWSTR ShaderPath, ShaderId val);
		static ShaderCompilationParameters Param_CompilePS_StdIncNoFlagsMainEntry(LPCWSTR ShaderPath, ShaderId val);
	};
